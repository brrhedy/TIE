...
if len(sys.argv) < 3:
    print 'Usage: python L2_train_predict_linearSVM.py train_file_path test_file_path output_result_path'
    exit(1)
...
if __name__ == "__main__":
    ...
    print "the L2_train_predict_linearSVM begin, the time is :"
